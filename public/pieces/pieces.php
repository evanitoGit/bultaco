                    ...
                    <div class="categorie-content" id="cat-<?php echo $categorie['id']; ?>" style="display: none;">
                        <?php foreach ($sousCategories as $sousCategorie): ?>
                            ...
                            <div class="sous-categorie-block">
                                <div class="sous-categorie-header" onclick="toggleSousCategorie(<?php echo $sousCategorie['id']; ?>)">
                                    <h4>
                                        <span class="arrow-small" id="arrow-sous-<?php echo $sousCategorie['id']; ?>">▶</span>
                                        <?php echo htmlspecialchars($sousCategorie['nom']); ?>
                                        <span class="badge-small"><?php echo $sousCategorie['nb_pieces']; ?></span>
                                    </h4>
                                </div>

                                <div class="sous-categorie-content" id="sous-cat-<?php echo $sousCategorie['id']; ?>" style="display: none;">
                                    <?php if (empty($pieces)): ?>
                                        <p class="no-pieces">Aucune pièce disponible pour le moment</p>
                                    <?php else: ?>
                                        <div class="pieces-grid">
                                            <?php foreach ($pieces as $piece): ?>
                                                <div class="piece-card" data-piece-id="<?php echo $piece['id']; ?>" data-piece-nom="<?php echo strtolower(htmlspecialchars($piece['nom'])); ?>">
                                                    ...
                                                    <div class="piece-info">
                                                        ...
                                                        <p class="piece-description"><?php echo htmlspecialchars($piece['description']); ?></p>
                                                        <div class="piece-footer">
                                                            <span class="piece-prix"><?php echo number_format($piece['prix'], 2, ',', ' '); ?> €</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endforeach; ?>
